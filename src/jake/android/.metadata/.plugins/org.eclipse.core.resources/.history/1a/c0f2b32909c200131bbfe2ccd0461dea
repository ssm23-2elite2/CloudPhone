 ...
 */
public class CloudPhoneCameraPreview extends CameraPreview {
	 ...
	 * @param writer 
	 */
	public CloudPhoneCameraPreview(Context context, int cameraId, LayoutMode mode, boolean addReversedSizes) {
